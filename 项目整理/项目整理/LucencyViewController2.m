...
@interface LucencyViewController2 ()<JHColumnChartDelegate,JHTableChartDelegate>

@end

@implementation LucencyViewController2
...
- (void)showPieChartUpView{
    JHPieChart *pie = [[JHPieChart alloc] initWithFrame:CGRectMake(100, 100, 200, 200)];
    ...
    pie.descArr = @[@"1",@"第二个元素",@"第三个元素",@"第四个元素",@"5",@"6",@"7",@"8"];
